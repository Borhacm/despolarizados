...
values
  ('El País', 'el-pais', array['https://feeds.elpais.com/mrss-s/pages/ep/site/elpais.com/portada']::text[], 'centro-izquierda', 'alta', 'Prisa', 5, true),
  ...
  ('La Vanguardia', 'la-vanguardia', array['https://www.lavanguardia.com/rss/home.xml']::text[], 'centro', 'alta', 'Grupo Godó', 4, true),
  ...
  ('El Confidencial', 'el-confidencial', array['https://www.elconfidencial.com/rss/noticias.xml']::text[], 'centro-derecha', 'alta', 'Titania Compañía Editorial', 4, true),
  ...
  ('El Independiente', 'el-independiente', array['https://www.elindependiente.com/rss']::text[], 'centro-derecha', 'media-alta', 'El Independiente', 3, true),
  ...
  ('Cinco Días', 'cinco-dias', array['https://cincodias.elpais.com/rss/cincodias/portada.xml']::text[], 'centro', 'alta', 'Prisa', 4, true),
  ...
  ('Diario Sur', 'diario-sur', array['https://www.diariosur.es/rss/atom/portada/']::text[], 'centro', 'media-alta', 'Vocento', 3, true),
  ('El Comercio', 'el-comercio', array['https://www.elcomercio.es/rss/atom/portada/']::text[], 'centro', 'media-alta', 'Vocento', 3, true),
  ...
  ('Moncloa', 'moncloa', array['https://www.moncloa.com/rss/']::text[], 'centro-derecha', 'media', 'Moncloa.com', 2, true),
  ('Canarias7', 'canarias7', array['https://www.canarias7.es/rss/atom/portada/']::text[], 'centro', 'media', 'Canarias7', 3, true),
  ('Heraldo de Aragón', 'heraldo', array['https://www.heraldo.es/rss']::text[], 'centro-derecha', 'media-alta', 'Grupo Henneo', 3, true),
  ...
  ('Málaga Hoy', 'malaga-hoy', array['https://www.malagahoy.es/rss']::text[], 'centro', 'media', 'Grupo Joly', 3, true),
  ...
  ('Las Provincias', 'las-provincias', array['https://www.lasprovincias.es/rss/atom/portada/']::text[], 'centro', 'media-alta', 'Vocento', 3, true),
