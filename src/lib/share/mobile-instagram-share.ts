/**
 * Detección de móvil y flujo pensado para Instagram (Stories / publicación con imagen).
...
/**
 * Comparte el PNG en el sheet del sistema; en móvil suele aparecer Instagram.
 * Orden: copiar URL al portapapeles y luego compartir archivo (leyenda se pega aparte).
 */
export async function shareStoryPngForInstagramFlow(input: {
  blob: Blob;
  fileName: string;
  title: string;
  caption: string;
