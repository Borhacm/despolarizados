/**
 * Iconos de marca para filas de compartir: color solo en el glifo, fondo neutro.
 */
...
export function IconReddit({ className = "h-5 w-5" }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" aria-hidden>
      <path
        fill="#FF4500"
        d="M12 0A12 12 0 0 0 0 12a12 12 0 0 0 12 12 12 12 0 0 0 12-12A12 12 0 0 0 12 0zm5.01 4.744c.688 0 1.25.561 1.25 1.249a1.25 1.25 0 0 1-2.498.056l-2.597-.547-.8 3.747c1.824.07 3.48.632 4.674 1.488.308-.309.73-.491 1.207-.491.968 0 1.754.786 1.754 1.754 0 .716-.435 1.333-1.01 1.614a3.111 3.111 0 0 1 .042.52c0 2.694-3.13 4.87-7.004 4.87-3.874 0-7.004-2.176-7.004-4.87 0-.183.015-.366.043-.534A1.748 1.748 0 0 1 4.028 12c0-.968.786-1.754 1.754-1.754.463 0 .898.196 1.207.49 1.207-.883 2.878-1.43 4.744-1.502l1.49-7.209 2.343.549c.029.01.057.018.086.018.688 0 1.25-.563 1.25-1.25 0-.688-.563-1.25-1.25-1.25-.688 0-1.25.563-1.25 1.25 0 .687.563 1.25 1.25 1.25.029 0 .057-.009.086-.018l2.717-.64c.118-.029.237-.018.345.029.106.047.192.134.237.248l1.573 7.326c1.82.07 3.48.632 4.674 1.488.308-.309.73-.491 1.207-.491.968 0 1.754.786 1.754 1.754 0 .716-.435 1.333-1.01 1.614.028.17.043.354.043.534 0 2.694-3.13 4.87-7.004 4.87-3.874 0-7.004-2.176-7.004-4.87 0-.183.015-.366.043-.534a1.748 1.748 0 0 1-1.01-1.614c0-.968.786-1.754 1.754-1.754.463 0 .898.196 1.207.49 1.207-.883 2.878-1.43 4.744-1.502l1.49-7.209 2.343.549c.029.01.057.018.086.018z"
      />
    </svg>
  );
}
...
export function IconLink({ className = "h-5 w-5" }: { className?: string }) {
  return (
    <svg
      className={`${className} text-zinc-600 dark:text-zinc-300`}
      viewBox="0 0 24 24"
      fill="none"
      stroke="currentColor"
      strokeWidth="2"
...
export function IconShareSystem({
  className = "h-5 w-5",
}: {
  className?: string;
}) {
  return (
    <svg
      className={`${className} text-emerald-700 dark:text-emerald-300`}
      viewBox="0 0 24 24"
      fill="none"
      stroke="currentColor"
      strokeWidth="2"
